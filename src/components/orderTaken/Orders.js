...
export function Order() {
    ...
    return (
        <div className="h-[100%] overflow-y-auto scrollbar-none no-scrollbar">
        {/* <div className="mt-12"> */}
            <div className=" sm:p-6 w-[100%]">
                <div className="m-auto gap-2">
                    ...
                    <div className="flex flex-col gap-10 mt-2 md:mt-8">
                        ...
                        <div className="flex flex-col w-full  gap-4 p-6 bg-gray-50 rounded-md text-gray-600">
